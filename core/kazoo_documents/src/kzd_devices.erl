...
-export([push_notification_subscriptions/1, push_notification_subscriptions/2, set_push_notification_subscriptions/2]).
...
-spec push_notification_subscriptions(doc()) -> kz_term:api_object().
push_notification_subscriptions(Doc) ->
    push_notification_subscriptions(Doc, 'undefined').

-spec push_notification_subscriptions(doc(), Default) -> kz_json:object() | Default.
push_notification_subscriptions(Doc, Default) ->
    kz_json:get_json_value([<<"push_notification_subscriptions">>], Doc, Default).

-spec set_push_notification_subscriptions(doc(), kz_json:object()) -> doc().
set_push_notification_subscriptions(Doc, PushNotificationSubscriptions) ->
    kz_json:set_value([<<"push_notification_subscriptions">>], PushNotificationSubscriptions, Doc).
