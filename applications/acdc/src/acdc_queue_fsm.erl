...
ready('cast', {'member_call', CallJObj, Delivery}, #state{queue_proc=QueueSrv}=State) ->
...
ready('cast', {'check_if_next', CallJObj, Delivery}, #state{queue_proc=QueueSrv
                                                           ,manager_proc=MgrSrv
                                                           ,member_call=Call
                                                           }=State) ->
...
ready('cast', {'retry', _RetryJObj}, State) ->
    ...
    {'next_state', 'ready', State};
ready('cast', {'member_hungup', CallEvt}, #state{member_call=Call}=State) when Call =/= 'undefined' ->
    CallId = kapps_call:call_id(Call),
