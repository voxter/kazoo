...
-spec wait_for_bridge(member_call(), breakout_state(), max_wait(), kz_time:now()) -> 'ok'.
...
-spec process_message(member_call(), breakout_state(), max_wait(), kz_time:now()
...
-spec process_dtmf(binary(), member_call(), breakout_state(), max_wait(), kz_time:now(), kz_time:now()) -> 'ok'.
