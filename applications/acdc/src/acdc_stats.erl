...
%%------------------------------------------------------------------------------
%% @doc Update the average_wait_time_estimation for a call stat
%% @end
%%------------------------------------------------------------------------------
-spec call_average_wait_time_estimated(kz_term:ne_binary(), kz_term:ne_binary(), kz_term:ne_binary(), integer()) -> 'ok'.
...
-spec agent_paused(kz_term:ne_binary(), kz_term:ne_binary(), kz_term:api_pos_integer(), kz_term:api_binary()) -> 'ok'.
...
%%------------------------------------------------------------------------------
%% @doc Get an estimation of the average wait time for a call with the
%% given properties.
%%
%% @end
%%------------------------------------------------------------------------------
...
-spec increment_agent_calls(kz_term:ne_binary(), kz_term:ne_binary(), kz_term:ne_binary(), map()) -> map().
...
-spec increment_agent_misses(kz_term:ne_binary(), kz_term:ne_binary(), map()) -> map().
increment_agent_misses(QueueId, AgentId, Map) ->
    increment_agent_call_stat(QueueId, AgentId, <<"missed_calls">>, Map).

-spec increment_agent_call_stat(kz_term:ne_binary(), kz_term:ne_binary(), kz_term:ne_binary(), map()) -> map().
...
-spec increment_agent_call_stat(kz_term:ne_binary(), kz_term:ne_binary(), map()) -> map().
...
-spec handle_average_wait_time_estimated_stat(kz_json:object(), kz_term:proplist()) -> 'ok'.
