...
-spec call_average_wait_time_estimated(kz_term:api_terms()) ->
          {'ok', iolist()} |
          {'error', string()}.
...
-spec call_average_wait_time_estimated_v(kz_term:api_terms()) -> boolean().
...
-spec publish_call_average_wait_time_estimated(kz_term:api_terms()) -> 'ok'.
publish_call_average_wait_time_estimated(JObj) ->
    publish_call_average_wait_time_estimated(JObj, ?DEFAULT_CONTENT_TYPE).

-spec publish_call_average_wait_time_estimated(kz_term:api_terms(), binary()) -> 'ok'.
