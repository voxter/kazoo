...
-record(state, {call :: kapps_call:call() | 'undefined'
               ,original_call :: kapps_call:call() | 'undefined'
...
-spec originate_callback_return(pid(), kapps_call:call(), {kz_term:api_binary(), kz_term:api_binary()}) -> kz_term:ne_binary().
...
%% @end
%%------------------------------------------------------------------------------
-spec do_originate_callback_return(kz_term:ne_binary(), kapps_call:call(), {kz_term:api_binary(), kz_term:api_binary()}) -> kz_term:ne_binary().
...
-spec maybe_start_recording(kapps_call:call(), kz_term:ne_binary(), kz_term:ne_binary(), boolean(), kz_term:ne_binary()) -> 'ok'.
...
-spec maybe_start_recording(kapps_call:call(), kz_term:ne_binary(), kz_term:ne_binary(), boolean(), kz_term:ne_binary(), kz_term:api_binary()) -> 'ok'.
