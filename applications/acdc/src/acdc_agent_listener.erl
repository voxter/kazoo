...
-spec hangup_call(pid(), kapps_call:call()) -> 'ok'.
hangup_call(Srv) ->
...
-spec monitor_call(pid(), kapps_call:call(), kz_json:object(), api_binary()) -> 'ok'.
...
handle_cast({'hangup_call', Call}, State) ->
    ...
    stop_agent_leg(CallId, kapps_call:control_queue(Call)),
