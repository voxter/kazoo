...
%% @private
%% @doc
%% Notify all processes listening using this event listener of a new
%% AMQP queue (Server-ID) to include in command props
%%--------------------------------------------------------------------
-spec notify_of_server_id(api_ne_binary(), pids()) -> 'ok'.
